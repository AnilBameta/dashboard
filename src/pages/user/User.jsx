      ...
      <div className="userContainer">
          <div className="userShow">
              ...
              <div className="userShowBottom">
                  ...
                  <span className="userShowInfoTitle">21.07.1992</span>
                  </div>
                  <div className="userShowInfo">
                  <PhoneAndroid className='userShowIcon'/>
                  <span className="userShowInfoTitle">123434356563</span>
                  </div>
                  <div className="userShowInfo">
                  ...
                  <span className="userShowInfoTitle">Bihar | Patna</span>
                  </div>
              </div>
          </div>
                      ...
                      <form className="userUpdateForm">
                        <div className="userUpdateLeft">
                            ...
                            <div className="userUpdateItem">
                                ...
                                <input type="text" placeholder="Anna Becker" className='userUpdateInput'></input>
                            </div>
                            <div className="userUpdateItem">
                                <label>Email</label>
                            ...
                            <div className="userUpdateItem">
                                <label>Pohone</label>
                                <input type="text" placeholder="232454653" className='userUpdateInput'></input>
                            </div>
                            <div className="userUpdateItem">
                                <label>Address</label>
                                <input type="text" placeholder="Bihar | Patna" className='userUpdateInput'></input>
                            </div>
                        </div>
